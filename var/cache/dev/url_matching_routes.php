...
return [
    ...
    [ // $staticRoutes
        ...
        '/collaborator' => [[['_route' => 'app_collaborator_create', '_controller' => 'App\\Controller\\CollaboratorController::createCollaborator'], null, ['POST' => 0], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_error/(\\d+)(?:\\.([^/]++))?(*:35)'
    ...
    [ // $dynamicRoutes
        ...
        67 => [
            [['_route' => 'app_collaborator_update', '_controller' => 'App\\Controller\\CollaboratorController::updateCollaborator'], ['id'], ['PUT' => 0], null, false, true, null],
